 ...
 * C source code generated on : Fri Oct 19 04:40:09 2018
 *
...
void P3p3_output0(void)                /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (rtmIsMajorTimeStep(P3p3_M)) {
    ...
    /* S-Function Block: P3p3/Heli 3D/HIL Read Encoder Timebase (hil_read_encoder_timebase_block) */
    {
      ...
      if (result < 0) {
        ...
        rtb_DeadZonex = P3p3_DW.HILReadEncoderTimebase_Buffer[2];
      }
    }
    ...
    /* Gain: '<S11>/Gain' */
    P3p3_B.Gain = P3p3_P.Gain_Gain * P3p3_B.PitchCounttorad;

    /* Sum: '<Root>/Sum1' incorporates:
     *  Constant: '<Root>/   '
     */
    P3p3_B.Sum1 = P3p3_B.Gain - P3p3_P.P_OFF;
  }
  ...
  if (rtmIsMajorTimeStep(P3p3_M)) {
    ...
    P3p3_B.ElevationCounttorad = P3p3_P.ElevationCounttorad_Gain * rtb_DeadZonex;

    /* Gain: '<S9>/Gain' */
    P3p3_B.Gain_e = P3p3_P.Gain_Gain_l * P3p3_B.ElevationCounttorad;

    /* Sum: '<Root>/Sum' incorporates:
     *  Constant: '<Root>/     '
     */
    P3p3_B.Sum = P3p3_B.Gain_e - P3p3_P.E_OFF;
  }
  ...
  if (rtmIsMajorTimeStep(P3p3_M)) {
    ...
    /* Gain: '<S13>/Gain' */
    P3p3_B.Gain_p = P3p3_P.Gain_Gain_ar * P3p3_B.TravelCounttorad;
  }

  /* Gain: '<S14>/Gain' incorporates:
   *  TransferFcn: '<S3>/Travel: Transfer Fcn'
   */
  P3p3_B.Gain_dc = (P3p3_P.TravelTransferFcn_C * P3p3_X.TravelTransferFcn_CSTATE
                    + P3p3_P.TravelTransferFcn_D * P3p3_B.TravelCounttorad) *
    P3p3_P.Gain_Gain_lu;

  /* Gain: '<S2>/Gain1' */
  P3p3_B.Gain1[0] = P3p3_P.Gain1_Gain * P3p3_B.Sum1;
  P3p3_B.Gain1[1] = P3p3_P.Gain1_Gain * P3p3_B.Gain_b;
  P3p3_B.Gain1[2] = P3p3_P.Gain1_Gain * P3p3_B.Sum;
  P3p3_B.Gain1[3] = P3p3_P.Gain1_Gain * P3p3_B.Gain_d;
  P3p3_B.Gain1[4] = P3p3_P.Gain1_Gain * P3p3_B.Gain_p;
  P3p3_B.Gain1[5] = P3p3_P.Gain1_Gain * P3p3_B.Gain_dc;
  if (rtmIsMajorTimeStep(P3p3_M)) {
    /* SignalConversion: '<S6>/TmpSignal ConversionAtTo WorkspaceInport1' */
    P3p3_B.TmpSignalConversionAtToWorkspac[0] = 0.0;
    P3p3_B.TmpSignalConversionAtToWorkspac[1] = P3p3_B.Gain1[1];
    ...
    if (P3p3_B.RateTransitionx > P3p3_P.DeadZonex_End) {
      rtb_DeadZonex = P3p3_B.RateTransitionx - P3p3_P.DeadZonex_End;
    } else if (P3p3_B.RateTransitionx >= P3p3_P.DeadZonex_Start) {
      rtb_DeadZonex = 0.0;
    } else {
      rtb_DeadZonex = P3p3_B.RateTransitionx - P3p3_P.DeadZonex_Start;
    }
     ...
     *  Gain: '<S4>/Gain: x'
     */
    P3p3_B.Joystick_gain_x = P3p3_P.Gainx_Gain * rtb_DeadZonex *
      P3p3_P.Joystick_gain_x;

    /* SignalConversion: '<S6>/TmpSignal ConversionAtTo Workspace1Inport1' */
    P3p3_B.TmpSignalConversionAtToWorksp_g[0] = P3p3_B.Joystick_gain_x;
    P3p3_B.TmpSignalConversionAtToWorksp_g[1] = P3p3_B.Gain1[0];
  }

  /* FromWorkspace: '<S7>/FromWs' */
  {
    real_T *pDataValues = (real_T *) P3p3_DW.FromWs_PWORK.DataPtr;
    real_T *pTimeValues = (real_T *) P3p3_DW.FromWs_PWORK.TimePtr;
    int_T currTimeIndex = P3p3_DW.FromWs_IWORK.PrevIndex;
    ...
    P3p3_DW.FromWs_IWORK.PrevIndex = currTimeIndex;
    ...
    /* Post output */
    {
      ...
      if (t1 == t2) {
        if (t < t1) {
          P3p3_B.FromWs = pDataValues[currTimeIndex];
        } else {
          P3p3_B.FromWs = pDataValues[currTimeIndex + 1];
        }
      } else {
        ...
        P3p3_B.FromWs = (real_T) rtInterpolate(d1, d2, f1, f2);
        pDataValues += 6;
      }
    }
  }
  ...
  if (rtmIsMajorTimeStep(P3p3_M)) {
    /* SignalConversion: '<S6>/TmpSignal ConversionAtTo Workspace2Inport1' */
    P3p3_B.TmpSignalConversionAtToWorksp_h[0] = P3p3_B.FromWs;
    P3p3_B.TmpSignalConversionAtToWorksp_h[1] = P3p3_B.Gain1[2];

    /* SignalConversion: '<S6>/TmpSignal ConversionAtTo Workspace3Inport1' */
    P3p3_B.TmpSignalConversionAtToWorksp_e[0] = P3p3_B.FromWs;
    P3p3_B.TmpSignalConversionAtToWorksp_e[1] = P3p3_B.Gain1[3];

    /* SignalConversion: '<S6>/TmpSignal ConversionAtTo Workspace4Inport1' */
    P3p3_B.TmpSignalConversionAtToWorksp_m[0] = 0.0;
    P3p3_B.TmpSignalConversionAtToWorksp_m[1] = P3p3_B.Gain1[4];

    /* SignalConversion: '<S6>/TmpSignal ConversionAtTo Workspace5Inport1' */
    P3p3_B.TmpSignalConversionAtToWorksp_a[0] = 0.0;
    P3p3_B.TmpSignalConversionAtToWorksp_a[1] = P3p3_B.Gain1[5];

    /* Constant: '<S5>/ ' */
    P3p3_B.u = P3p3_P.V_star;

    /* Constant: '<S5>/    ' */
    P3p3_B.u_k[0] = P3p3_P.P[0];
    P3p3_B.u_k[1] = P3p3_P.P[1];
    P3p3_B.u_k[2] = P3p3_P.P[2];
    P3p3_B.u_k[3] = P3p3_P.P[3];

    /* Constant: '<S5>/          ' */
    memcpy(&P3p3_B.u_g[0], &P3p3_P.K_bar[0], 10U * sizeof(real_T));
  }
   ...
   *  Product: '<S5>/Product2'
   */
  tmp[0] = P3p3_B.Gain1[0];
  tmp[1] = P3p3_B.Gain1[1];
  tmp[2] = P3p3_B.Gain1[3];
  ...
  for (i = 0; i < 2; i++) {
    tmp_0[i] = 0.0;
    for (i_0 = 0; i_0 < 5; i_0++) {
      tmp_0[i] += P3p3_B.u_g[(i_0 << 1) + i] * tmp[i_0];
    }
  }
   ...
   */
  rtb_Add_k_idx_1 = (P3p3_B.u_k[1] * P3p3_B.Joystick_gain_x + P3p3_B.u_k[3] *
                     P3p3_B.FromWs) - tmp_0[1];
   ...
   *  Sum: '<S5>/Add'
   */
  P3p3_B.Sum3 = ((P3p3_B.u_k[0] * P3p3_B.Joystick_gain_x + P3p3_B.u_k[2] *
                  P3p3_B.FromWs) - tmp_0[0]) + P3p3_B.u;
  if (rtmIsMajorTimeStep(P3p3_M)) {
  }
   ...
   *  Sum: '<S1>/Add'
   */
  u0 = (rtb_Add_k_idx_1 + P3p3_B.Sum3) * P3p3_P.Frontgain_Gain;
   ...
   *  Sum: '<S1>/Subtract'
   */
  u0 = (P3p3_B.Sum3 - rtb_Add_k_idx_1) * P3p3_P.Backgain_Gain;
  ...
  /* Sum: '<S8>/Sum1' */
  P3p3_B.Sum1_b = P3p3_B.Gain1[0] - P3p3_B.Joystick_gain_x;

  /* Sum: '<S8>/Sum2' */
  P3p3_B.Sum2 = P3p3_B.Gain1[3] - P3p3_B.FromWs;
}
...
void P3p3_derivatives(void)
{
  ...
  _rtXdot->Integrator_CSTATE = P3p3_B.Sum1_b;
...
void P3p3_initialize(void)
{
  ...
  {
    static real_T pTimeValues0[] = { 0.0, 3.0, 3.0, 5.0, 5.0, 10.0 } ;

    static real_T pDataValues0[] = { -0.0, -0.0, 0.3, 0.3, -0.0, 0.0 } ;

    P3p3_DW.FromWs_PWORK.TimePtr = (void *) pTimeValues0;
    P3p3_DW.FromWs_PWORK.DataPtr = (void *) pDataValues0;
    P3p3_DW.FromWs_IWORK.PrevIndex = 0;
  }
...
RT_MODEL_P3p3_T *P3p3(void)
{
  ...
  rtmSetTFinal(P3p3_M, 9.9);
  P3p3_M->Timing.stepSize0 = 0.002;
  P3p3_M->Timing.stepSize1 = 0.002;
  P3p3_M->Timing.stepSize2 = 0.01;

  /* External mode info */
  P3p3_M->Sizes.checksums[0] = (3810803745U);
  P3p3_M->Sizes.checksums[1] = (1479500315U);
  P3p3_M->Sizes.checksums[2] = (155314415U);
  P3p3_M->Sizes.checksums[3] = (482588850U);
...

  {
    ...
    P3p3_B.Gain_dc = 0.0;
    P3p3_B.TmpSignalConversionAtToWorkspac[0] = 0.0;
    P3p3_B.TmpSignalConversionAtToWorkspac[1] = 0.0;
    P3p3_B.RateTransitionx = 0.0;
    P3p3_B.Joystick_gain_x = 0.0;
    P3p3_B.TmpSignalConversionAtToWorksp_g[0] = 0.0;
    P3p3_B.TmpSignalConversionAtToWorksp_g[1] = 0.0;
    P3p3_B.FromWs = 0.0;
    P3p3_B.TmpSignalConversionAtToWorksp_h[0] = 0.0;
    P3p3_B.TmpSignalConversionAtToWorksp_h[1] = 0.0;
    P3p3_B.TmpSignalConversionAtToWorksp_e[0] = 0.0;
    P3p3_B.TmpSignalConversionAtToWorksp_e[1] = 0.0;
    P3p3_B.TmpSignalConversionAtToWorksp_m[0] = 0.0;
    P3p3_B.TmpSignalConversionAtToWorksp_m[1] = 0.0;
    P3p3_B.TmpSignalConversionAtToWorksp_a[0] = 0.0;
    P3p3_B.TmpSignalConversionAtToWorksp_a[1] = 0.0;
    P3p3_B.u = 0.0;
    P3p3_B.u_k[0] = 0.0;
    P3p3_B.u_k[1] = 0.0;
    P3p3_B.u_k[2] = 0.0;
  ...
  P3p3_M->Sizes.numBlockIO = (30);     /* Number of block outputs */
  P3p3_M->Sizes.numBlockPrms = (156);  /* Sum of parameter "widths" */
  return P3p3_M;
}
