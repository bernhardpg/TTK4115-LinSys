...
typedef struct {
  ...
  struct {
    void *LoggedData;
  } Elevrate_PWORK;                    /* '<S8>/Elev rate' */

  struct {
    void *LoggedData;
  } Pitchrate_PWORK;                   /* '<S8>/Pitch rate' */
...
extern void P3p3_output0(void);
extern void P3p3_update0(void);
extern void P3p3_output(int_T tid);
extern void P3p3_update(int_T tid);
 ...
 * '<S3>'   : 'P3p3/Heli 3D'
 * '<S4>'   : 'P3p3/Joystick'
 * '<S5>'   : 'P3p3/LQR regulator'
 * '<S6>'   : 'P3p3/Plot1'
 * '<S7>'   : 'P3p3/Signal Builder'
 * '<S8>'   : 'P3p3/State augmenter'
 * '<S9>'   : 'P3p3/Heli 3D/Elevation rad to deg'
 * '<S10>'  : 'P3p3/Heli 3D/Elevation rate rad to deg'
 * '<S11>'  : 'P3p3/Heli 3D/Pitch rad to deg'
 * '<S12>'  : 'P3p3/Heli 3D/Pitch rate rad to deg'
 * '<S13>'  : 'P3p3/Heli 3D/Travel rad to deg'
 * '<S14>'  : 'P3p3/Heli 3D/Travel rate  rad to deg'
 */
