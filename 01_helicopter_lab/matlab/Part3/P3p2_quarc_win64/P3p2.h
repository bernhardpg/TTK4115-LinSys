...
extern void P3p2_output0(void);
extern void P3p2_update0(void);
extern void P3p2_output(int_T tid);
extern void P3p2_update(int_T tid);
 ...
 * '<Root>' : 'P3p2'
 * '<S1>'   : 'P3p2/Conversion'
 * '<S2>'   : 'P3p2/Degrees to Radians'
 * '<S3>'   : 'P3p2/Heli 3D'
 * '<S4>'   : 'P3p2/Joystick'
 * '<S5>'   : 'P3p2/LQR regulator'
 * '<S6>'   : 'P3p2/Plot'
 * '<S7>'   : 'P3p2/Signal Builder'
 * '<S8>'   : 'P3p2/Signal Builder Y'
 * '<S9>'   : 'P3p2/Heli 3D/Elevation rad to deg'
 * '<S10>'  : 'P3p2/Heli 3D/Elevation rate rad to deg'
 * '<S11>'  : 'P3p2/Heli 3D/Pitch rad to deg'
 * '<S12>'  : 'P3p2/Heli 3D/Pitch rate rad to deg'
 * '<S13>'  : 'P3p2/Heli 3D/Travel rad to deg'
 * '<S14>'  : 'P3p2/Heli 3D/Travel rate  rad to deg'
 */
