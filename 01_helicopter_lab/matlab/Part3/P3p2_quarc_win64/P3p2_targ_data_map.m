  ...
  ;%***********************
    ...
    ;%
	  ...
	  ;% P3p2_P.HILInitialize_set_other_outpu_j
	  ...
	  ;% P3p2_P.HILInitialize_set_analog_inpu_m
	  ...
	  ;% P3p2_P.HILInitialize_set_analog_outp_b
	  ...
	  ;% P3p2_P.HILInitialize_set_analog_outp_c
	  section.data(10).logicalSrcIdx = 48;
	  section.data(10).dtTransOffset = 9;
	
	  ;% P3p2_P.HILInitialize_set_analog_out_ex
	  section.data(11).logicalSrcIdx = 49;
	  section.data(11).dtTransOffset = 10;
	
	  ;% P3p2_P.HILInitialize_set_analog_outp_p
	  ...
	  ;% P3p2_P.HILInitialize_set_clock_frequ_e
	  ...
	  ;% P3p2_P.HILInitialize_set_clock_param_c
	  ...
	  ;% P3p2_P.HILInitialize_set_digital_ou_c1
	  ...
	  ;% P3p2_P.HILInitialize_set_digital_out_m
	  ...
	  ;% P3p2_P.HILInitialize_set_encoder_cou_k
	  ...
	  ;% P3p2_P.HILInitialize_set_encoder_par_m
	  ...
	  ;% P3p2_P.HILInitialize_set_pwm_outputs_p
	  section.data(31).logicalSrcIdx = 69;
	  section.data(31).dtTransOffset = 30;
	
	  ;% P3p2_P.HILInitialize_set_pwm_output_ap
	  ...
	  ;% P3p2_P.HILInitialize_set_pwm_params__f
  ...
  ;%**************************
    ...
    ;%
	  ...
	  ;% P3p2_B.TmpSignalConversionAtToWorkspac
	  section.data(13).logicalSrcIdx = 12;
	  ...
	  ;% P3p2_B.TmpSignalConversionAtToWorksp_g
	  section.data(16).logicalSrcIdx = 15;
	  ...
	  ;% P3p2_B.TmpSignalConversionAtToWorksp_h
	  section.data(18).logicalSrcIdx = 17;
	  section.data(18).dtTransOffset = 24;
	
	  ;% P3p2_B.TmpSignalConversionAtToWorksp_e
	  section.data(19).logicalSrcIdx = 18;
	  section.data(19).dtTransOffset = 26;
	
	  ;% P3p2_B.TmpSignalConversionAtToWorksp_m
	  section.data(20).logicalSrcIdx = 19;
	  section.data(20).dtTransOffset = 28;
	
	  ;% P3p2_B.TmpSignalConversionAtToWorksp_a
	  section.data(21).logicalSrcIdx = 20;
  ...
  ;%*******************
    ...
    ;%
	  ...
	  ;% P3p2_DW.ToWorkspace5_PWORK.LoggedData
	  section.data(7).logicalSrcIdx = 19;
	  section.data(7).dtTransOffset = 6;
	
	  ;% P3p2_DW.Vs_PWORK.LoggedData
	  ...
	  ;% P3p2_DW.FromWs_IWORK.PrevIndex
  ...
  targMap.checksum0 = 1390816028;
  targMap.checksum1 = 2615698588;
  targMap.checksum2 = 3988139704;
  targMap.checksum3 = 2866783273;
