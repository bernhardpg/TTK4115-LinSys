 ...
 * C source code generated on : Fri Oct 19 04:46:33 2018
 *
...
void P3p2_output0(void)                /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (rtmIsMajorTimeStep(P3p2_M)) {
    ...
    /* S-Function Block: P3p2/Heli 3D/HIL Read Encoder Timebase (hil_read_encoder_timebase_block) */
    {
      ...
      if (result < 0) {
        ...
        rtb_DeadZonex = P3p2_DW.HILReadEncoderTimebase_Buffer[2];
      }
    }
     ...
     *  Constant: '<Root>/   '
     */
    P3p2_B.Sum1 = P3p2_B.Gain - P3p2_P.P_OFF;
  }
  ...
  if (rtmIsMajorTimeStep(P3p2_M)) {
    ...
    P3p2_B.ElevationCounttorad = P3p2_P.ElevationCounttorad_Gain * rtb_DeadZonex;
     ...
     *  Constant: '<Root>/     '
     */
    P3p2_B.Sum = P3p2_B.Gain_e - P3p2_P.E_OFF;
  }
  ...
  /* Gain: '<S2>/Gain1' */
  P3p2_B.Gain1[0] = P3p2_P.Gain1_Gain * P3p2_B.Sum1;
  P3p2_B.Gain1[1] = P3p2_P.Gain1_Gain * P3p2_B.Gain_b;
  P3p2_B.Gain1[2] = P3p2_P.Gain1_Gain * P3p2_B.Sum;
  P3p2_B.Gain1[3] = P3p2_P.Gain1_Gain * P3p2_B.Gain_d;
  P3p2_B.Gain1[4] = P3p2_P.Gain1_Gain * P3p2_B.Gain_p;
  P3p2_B.Gain1[5] = P3p2_P.Gain1_Gain * P3p2_B.Gain_dc;
  if (rtmIsMajorTimeStep(P3p2_M)) {
    /* SignalConversion: '<S6>/TmpSignal ConversionAtTo WorkspaceInport1' */
    P3p2_B.TmpSignalConversionAtToWorkspac[0] = 0.0;
    P3p2_B.TmpSignalConversionAtToWorkspac[1] = P3p2_B.Gain1[1];
    ...
    if (P3p2_B.RateTransitionx > P3p2_P.DeadZonex_End) {
      rtb_DeadZonex = P3p2_B.RateTransitionx - P3p2_P.DeadZonex_End;
    } else if (P3p2_B.RateTransitionx >= P3p2_P.DeadZonex_Start) {
      rtb_DeadZonex = 0.0;
    } else {
      rtb_DeadZonex = P3p2_B.RateTransitionx - P3p2_P.DeadZonex_Start;
    }
     ...
     *  Gain: '<S4>/Gain: x'
     */
    P3p2_B.Joystick_gain_x = P3p2_P.Gainx_Gain * rtb_DeadZonex *
      P3p2_P.Joystick_gain_x;

    /* SignalConversion: '<S6>/TmpSignal ConversionAtTo Workspace1Inport1' */
    P3p2_B.TmpSignalConversionAtToWorksp_g[0] = P3p2_B.Joystick_gain_x;
    P3p2_B.TmpSignalConversionAtToWorksp_g[1] = P3p2_B.Gain1[0];
  }

  /* FromWorkspace: '<S8>/FromWs' */
  {
    real_T *pDataValues = (real_T *) P3p2_DW.FromWs_PWORK.DataPtr;
    real_T *pTimeValues = (real_T *) P3p2_DW.FromWs_PWORK.TimePtr;
    int_T currTimeIndex = P3p2_DW.FromWs_IWORK.PrevIndex;
    real_T t = P3p2_M->Timing.t[0];
    ...
    P3p2_DW.FromWs_IWORK.PrevIndex = currTimeIndex;
    ...
    /* Post output */
    {
      ...
      if (t1 == t2) {
        if (t < t1) {
          P3p2_B.FromWs = pDataValues[currTimeIndex];
        } else {
          P3p2_B.FromWs = pDataValues[currTimeIndex + 1];
        }
      } else {
        ...
        P3p2_B.FromWs = (real_T) rtInterpolate(d1, d2, f1, f2);
        pDataValues += 6;
      }
    }
  }
  ...
  if (rtmIsMajorTimeStep(P3p2_M)) {
    ...
    P3p2_B.TmpSignalConversionAtToWorksp_h[0] = P3p2_B.FromWs;
    P3p2_B.TmpSignalConversionAtToWorksp_h[1] = P3p2_B.Gain1[2];

    /* SignalConversion: '<S6>/TmpSignal ConversionAtTo Workspace3Inport1' */
    P3p2_B.TmpSignalConversionAtToWorksp_e[0] = P3p2_B.FromWs;
    P3p2_B.TmpSignalConversionAtToWorksp_e[1] = P3p2_B.Gain1[3];

    /* SignalConversion: '<S6>/TmpSignal ConversionAtTo Workspace4Inport1' */
    P3p2_B.TmpSignalConversionAtToWorksp_m[0] = 0.0;
    P3p2_B.TmpSignalConversionAtToWorksp_m[1] = P3p2_B.Gain1[4];

    /* SignalConversion: '<S6>/TmpSignal ConversionAtTo Workspace5Inport1' */
    P3p2_B.TmpSignalConversionAtToWorksp_a[0] = 0.0;
    P3p2_B.TmpSignalConversionAtToWorksp_a[1] = P3p2_B.Gain1[5];

    /* Constant: '<S5>/ ' */
    P3p2_B.u = P3p2_P.V_star;

    /* Constant: '<S5>/Constant1' */
    P3p2_B.Constant1[0] = P3p2_P.P[0];
    P3p2_B.Constant1[1] = P3p2_P.P[1];
    P3p2_B.Constant1[2] = P3p2_P.P[2];
    P3p2_B.Constant1[3] = P3p2_P.P[3];

    /* Constant: '<S5>/Constant' */
    for (i = 0; i < 6; i++) {
      P3p2_B.Constant[i] = P3p2_P.K[i];
    }
   ...
   */
  for (i = 0; i < 2; i++) {
    tmp[i] = P3p2_B.Constant[i + 4] * P3p2_B.Gain1[3] + (P3p2_B.Constant[i + 2] *
      P3p2_B.Gain1[1] + P3p2_B.Constant[i] * P3p2_B.Gain1[0]);
  }
   ...
   */
  rtb_Add_k_idx_1 = (P3p2_B.Constant1[1] * P3p2_B.Joystick_gain_x +
                     P3p2_B.Constant1[3] * P3p2_B.FromWs) - tmp[1];
   ...
   *  Sum: '<S5>/Add'
   */
  P3p2_B.Sum3 = ((P3p2_B.Constant1[0] * P3p2_B.Joystick_gain_x +
                  P3p2_B.Constant1[2] * P3p2_B.FromWs) - tmp[0]) + P3p2_B.u;
  if (rtmIsMajorTimeStep(P3p2_M)) {
  }
   ...
   *  Sum: '<S1>/Add'
   */
  u0 = (rtb_Add_k_idx_1 + P3p2_B.Sum3) * P3p2_P.Frontgain_Gain;
   ...
   *  Sum: '<S1>/Subtract'
   */
  u0 = (P3p2_B.Sum3 - rtb_Add_k_idx_1) * P3p2_P.Backgain_Gain;
...
void P3p2_initialize(void)
{
  ...
  /* Start for FromWorkspace: '<S8>/FromWs' */
  {
    ...
    P3p2_DW.FromWs_PWORK.TimePtr = (void *) pTimeValues0;
    P3p2_DW.FromWs_PWORK.DataPtr = (void *) pDataValues0;
    P3p2_DW.FromWs_IWORK.PrevIndex = 0;
  }
...
RT_MODEL_P3p2_T *P3p2(void)
{
  ...
  rtmSetTFinal(P3p2_M, 9.9);
  P3p2_M->Timing.stepSize0 = 0.002;
  P3p2_M->Timing.stepSize1 = 0.002;
  P3p2_M->Timing.stepSize2 = 0.01;

  /* External mode info */
  P3p2_M->Sizes.checksums[0] = (1390816028U);
  P3p2_M->Sizes.checksums[1] = (2615698588U);
  P3p2_M->Sizes.checksums[2] = (3988139704U);
  P3p2_M->Sizes.checksums[3] = (2866783273U);
...

  {
    ...
    P3p2_B.Gain_dc = 0.0;
    P3p2_B.TmpSignalConversionAtToWorkspac[0] = 0.0;
    P3p2_B.TmpSignalConversionAtToWorkspac[1] = 0.0;
    P3p2_B.RateTransitionx = 0.0;
    P3p2_B.Joystick_gain_x = 0.0;
    P3p2_B.TmpSignalConversionAtToWorksp_g[0] = 0.0;
    P3p2_B.TmpSignalConversionAtToWorksp_g[1] = 0.0;
    P3p2_B.FromWs = 0.0;
    P3p2_B.TmpSignalConversionAtToWorksp_h[0] = 0.0;
    P3p2_B.TmpSignalConversionAtToWorksp_h[1] = 0.0;
    P3p2_B.TmpSignalConversionAtToWorksp_e[0] = 0.0;
    P3p2_B.TmpSignalConversionAtToWorksp_e[1] = 0.0;
    P3p2_B.TmpSignalConversionAtToWorksp_m[0] = 0.0;
    P3p2_B.TmpSignalConversionAtToWorksp_m[1] = 0.0;
    P3p2_B.TmpSignalConversionAtToWorksp_a[0] = 0.0;
    P3p2_B.TmpSignalConversionAtToWorksp_a[1] = 0.0;
    P3p2_B.u = 0.0;
    P3p2_B.Constant1[0] = 0.0;
    P3p2_B.Constant1[1] = 0.0;
    P3p2_B.Constant1[2] = 0.0;
    P3p2_B.Constant1[3] = 0.0;
    P3p2_B.Sum3 = 0.0;
  ...
  P3p2_M->Sizes.numBlocks = (60);      /* Number of blocks */
  P3p2_M->Sizes.numBlockIO = (28);     /* Number of block outputs */
  P3p2_M->Sizes.numBlockPrms = (150);  /* Sum of parameter "widths" */
  return P3p2_M;
}
