  ...
  ;%***********************
    ...
    ;%
	  ...
	  section.data(6).dtTransOffset = 73;
	  ...
	  section.data(8).dtTransOffset = 95;
  ...
  ;%**************************
    ...
    ;%
	  ...
	  ;% P4p2_B.TmpSignalConversionAtToWorkspac
	  section.data(14).logicalSrcIdx = 13;
	  section.data(14).dtTransOffset = 23;
	
	  ;% P4p2_B.TmpSignalConversionAtToWorksp_g
	  section.data(15).logicalSrcIdx = 14;
	  section.data(15).dtTransOffset = 25;
	
	  ;% P4p2_B.TmpSignalConversionAtToWorksp_h
	  section.data(16).logicalSrcIdx = 15;
	  section.data(16).dtTransOffset = 27;
	
	  ;% P4p2_B.TmpSignalConversionAtToWorksp_e
	  section.data(17).logicalSrcIdx = 16;
	  section.data(17).dtTransOffset = 29;
	
	  ;% P4p2_B.TmpSignalConversionAtToWorksp_m
	  section.data(18).logicalSrcIdx = 17;
	  section.data(18).dtTransOffset = 31;
	
	  ;% P4p2_B.TmpSignalConversionAtToWorksp_a
	  section.data(19).logicalSrcIdx = 18;
	  ...
	  section.data(29).dtTransOffset = 97;
	
	  ;% P4p2_B.Add1
	  section.data(30).logicalSrcIdx = 29;
	  section.data(30).dtTransOffset = 133;
  ...
  ;%*******************
    ...
    ;%
	  ...
	  ;% P4p2_DW.FromWs_PWORK.TimePtr
	  section.data(7).logicalSrcIdx = 18;
	  section.data(7).dtTransOffset = 6;
	
	  ;% P4p2_DW.Vs_PWORK.LoggedData
	  ...
	  ;% P4p2_DW.FromWs_IWORK.PrevIndex
  ...
  targMap.checksum0 = 2232702602;
  targMap.checksum1 = 2588038860;
  targMap.checksum2 = 1935868712;
  targMap.checksum3 = 3745164532;
