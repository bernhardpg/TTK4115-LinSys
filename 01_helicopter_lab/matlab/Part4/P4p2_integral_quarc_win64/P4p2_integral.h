...
typedef struct {
  ...
  real_T Gain_dc;                      /* '<S15>/Gain' */
  real_T Gain1[6];                     /* '<S2>/Gain1' */
  real_T Integrator[6];                /* '<S6>/Integrator' */
  real_T TmpSignalConversionAtToWorkspac[2];
  real_T TmpSignalConversionAtToWorksp_g[2];
  real_T TmpSignalConversionAtToWorksp_h[2];
  real_T TmpSignalConversionAtToWorksp_e[2];
  real_T TmpSignalConversionAtToWorksp_m[2];
  real_T TmpSignalConversionAtToWorksp_a[2];
  real_T u;                            /* '<S5>/ ' */
  real_T Constant1[4];                 /* '<S5>/Constant1' */
  real_T Constant[10];                 /* '<S5>/Constant' */
  real_T Sum3;                         /* '<S5>/Sum3' */
  real_T FrontmotorSaturation;         /* '<S3>/Front motor: Saturation' */
  real_T BackmotorSaturation;          /* '<S3>/Back motor: Saturation' */
  real_T Constant1_i[18];              /* '<S6>/Constant1' */
  real_T Constant2[18];                /* '<S6>/Constant2' */
  real_T Constant3[12];                /* '<S6>/Constant3' */
  real_T Constant4[36];                /* '<S6>/Constant4' */
  real_T Add1[6];                      /* '<S6>/Add1' */
  real_T Sum1_b;                       /* '<S9>/Sum1' */
  real_T Sum2;                         /* '<S9>/Sum2' */
} B_P4p2_integral_T;
...
struct P_P4p2_integral_T_ {
  real_T A_se[36];                     /* Variable: A_se
                                        * Referenced by: '<S6>/Constant4'
                                        */
  real_T B_se[12];                     /* Variable: B_se
                                        * Referenced by: '<S6>/Constant3'
                                        */
  real_T C_se[18];                     /* Variable: C_se
                                        * Referenced by: '<S6>/Constant1'
                                        */
  real_T E_OFF;                        /* Variable: E_OFF
                                        * Referenced by: '<Root>/     '
                                        */
  real_T K_bar[10];                    /* Variable: K_bar
  ...
  real_T Integrator1_IC;               /* Expression: 0
                                        ...
                                        */
  real_T Backgain_Gain;                /* Expression: 0.50
...
extern void P4p2_integral_output0(void);
extern void P4p2_integral_update0(void);
extern void P4p2_integral_output(int_T tid);
extern void P4p2_integral_update(int_T tid);
 ...
 * '<S2>'   : 'P4p2_integral/Degrees to Radians'
 * '<S3>'   : 'P4p2_integral/Heli 3D'
 * '<S4>'   : 'P4p2_integral/Joystick'
 * '<S5>'   : 'P4p2_integral/LQR regulator'
 * '<S6>'   : 'P4p2_integral/Observer'
 * '<S7>'   : 'P4p2_integral/Plot1'
 * '<S8>'   : 'P4p2_integral/Signal Builder'
 * '<S9>'   : 'P4p2_integral/State augmenter'
 * '<S10>'  : 'P4p2_integral/Heli 3D/Elevation rad to deg'
 * '<S11>'  : 'P4p2_integral/Heli 3D/Elevation rate rad to deg'
 * '<S12>'  : 'P4p2_integral/Heli 3D/Pitch rad to deg'
 * '<S13>'  : 'P4p2_integral/Heli 3D/Pitch rate rad to deg'
 * '<S14>'  : 'P4p2_integral/Heli 3D/Travel rad to deg'
 * '<S15>'  : 'P4p2_integral/Heli 3D/Travel rate  rad to deg'
 */
