  ...
  ;%***********************
    ...
    ;%
	  ...
	  section.data(7).dtTransOffset = 95;
	
	  ;% P4p2_integral_P.V_star
	  ...
	  ;% P4p2_integral_P.Integrator_IC_i
  ...
  ;%**************************
    ...
    ;%
	  ...
	  ;% P4p2_integral_B.TmpSignalConversionAtToWorkspac
	  section.data(14).logicalSrcIdx = 13;
	  section.data(14).dtTransOffset = 23;
	
	  ;% P4p2_integral_B.TmpSignalConversionAtToWorksp_g
	  section.data(15).logicalSrcIdx = 14;
	  section.data(15).dtTransOffset = 25;
	
	  ;% P4p2_integral_B.TmpSignalConversionAtToWorksp_h
	  section.data(16).logicalSrcIdx = 15;
	  section.data(16).dtTransOffset = 27;
	
	  ;% P4p2_integral_B.TmpSignalConversionAtToWorksp_e
	  section.data(17).logicalSrcIdx = 16;
	  section.data(17).dtTransOffset = 29;
	
	  ;% P4p2_integral_B.TmpSignalConversionAtToWorksp_m
	  section.data(18).logicalSrcIdx = 17;
	  section.data(18).dtTransOffset = 31;
	
	  ;% P4p2_integral_B.TmpSignalConversionAtToWorksp_a
	  section.data(19).logicalSrcIdx = 18;
  ...
  ;%*******************
    ...
    ;%
	  ...
	  ;% P4p2_integral_DW.FromWs_PWORK.TimePtr
	  section.data(7).logicalSrcIdx = 18;
	  section.data(7).dtTransOffset = 6;
	
	  ;% P4p2_integral_DW.Vs_PWORK.LoggedData
	  ...
	  ;% P4p2_integral_DW.FromWs_IWORK.PrevIndex
  ...
  targMap.checksum0 = 3535217381;
  targMap.checksum1 = 4028667009;
  targMap.checksum2 = 40694054;
  targMap.checksum3 = 4270493259;
