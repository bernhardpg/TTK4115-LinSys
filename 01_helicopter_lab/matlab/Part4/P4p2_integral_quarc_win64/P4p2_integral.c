 ...
 * C source code generated on : Fri Oct 19 05:42:51 2018
 *
...
void P4p2_integral_output0(void)       /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (rtmIsMajorTimeStep(P4p2_integral_M)) {
    ...
    /* S-Function Block: P4p2_integral/Heli 3D/HIL Read Encoder Timebase (hil_read_encoder_timebase_block) */
    {
      ...
      if (result < 0) {
        ...
        rtb_HILReadEncoderTimebase_o3 =
          P4p2_integral_DW.HILReadEncoderTimebase_Buffer[2];
      }
    }
     ...
     *  Constant: '<Root>/   '
     */
    P4p2_integral_B.Sum1 = P4p2_integral_B.Gain - P4p2_integral_P._Value;
  }

  /* TransferFcn: '<S3>/Pitch: Transfer Fcn' */
  rtb_FromWs = 0.0;
  rtb_FromWs += P4p2_integral_P.PitchTransferFcn_C *
    P4p2_integral_X.PitchTransferFcn_CSTATE;
  rtb_FromWs += P4p2_integral_P.PitchTransferFcn_D *
    P4p2_integral_B.PitchCounttorad;

  /* Gain: '<S13>/Gain' */
  P4p2_integral_B.Gain_b = P4p2_integral_P.Gain_Gain_a * rtb_FromWs;
  if (rtmIsMajorTimeStep(P4p2_integral_M)) {
    /* Gain: '<S3>/Elevation: Count to rad' */
    P4p2_integral_B.ElevationCounttorad =
      P4p2_integral_P.ElevationCounttorad_Gain * rtb_HILReadEncoderTimebase_o3;
     ...
     *  Constant: '<Root>/     '
     */
    P4p2_integral_B.Sum = P4p2_integral_B.Gain_e - P4p2_integral_P.E_OFF;
  }

  /* TransferFcn: '<S3>/Elevation: Transfer Fcn' */
  rtb_FromWs = 0.0;
  rtb_FromWs += P4p2_integral_P.ElevationTransferFcn_C *
    P4p2_integral_X.ElevationTransferFcn_CSTATE;
  rtb_FromWs += P4p2_integral_P.ElevationTransferFcn_D *
    P4p2_integral_B.ElevationCounttorad;

  /* Gain: '<S11>/Gain' */
  P4p2_integral_B.Gain_d = P4p2_integral_P.Gain_Gain_n * rtb_FromWs;
  if (rtmIsMajorTimeStep(P4p2_integral_M)) {
  ...
  rtb_FromWs = 0.0;
  rtb_FromWs += P4p2_integral_P.TravelTransferFcn_C *
    P4p2_integral_X.TravelTransferFcn_CSTATE;
  rtb_FromWs += P4p2_integral_P.TravelTransferFcn_D *
    P4p2_integral_B.TravelCounttorad;

  /* Gain: '<S15>/Gain' */
  P4p2_integral_B.Gain_dc = P4p2_integral_P.Gain_Gain_lu * rtb_FromWs;

  /* Gain: '<S2>/Gain1' */
  P4p2_integral_B.Gain1[0] = P4p2_integral_P.Gain1_Gain * P4p2_integral_B.Sum1;
  P4p2_integral_B.Gain1[1] = P4p2_integral_P.Gain1_Gain * P4p2_integral_B.Gain_b;
  P4p2_integral_B.Gain1[2] = P4p2_integral_P.Gain1_Gain * P4p2_integral_B.Sum;
  P4p2_integral_B.Gain1[3] = P4p2_integral_P.Gain1_Gain * P4p2_integral_B.Gain_d;
  P4p2_integral_B.Gain1[4] = P4p2_integral_P.Gain1_Gain * P4p2_integral_B.Gain_p;
  P4p2_integral_B.Gain1[5] = P4p2_integral_P.Gain1_Gain *
    P4p2_integral_B.Gain_dc;
  ...
  if (rtmIsMajorTimeStep(P4p2_integral_M)) {
    ...
    P4p2_integral_B.TmpSignalConversionAtToWorkspac[0] = P4p2_integral_B.Gain1[1];
    P4p2_integral_B.TmpSignalConversionAtToWorkspac[1] =
      P4p2_integral_B.Integrator[1];

    /* SignalConversion: '<S7>/TmpSignal ConversionAtTo Workspace1Inport1' */
    P4p2_integral_B.TmpSignalConversionAtToWorksp_g[0] = P4p2_integral_B.Gain1[0];
    P4p2_integral_B.TmpSignalConversionAtToWorksp_g[1] =
      P4p2_integral_B.Integrator[0];

    /* SignalConversion: '<S7>/TmpSignal ConversionAtTo Workspace2Inport1' */
    P4p2_integral_B.TmpSignalConversionAtToWorksp_h[0] = P4p2_integral_B.Gain1[2];
    P4p2_integral_B.TmpSignalConversionAtToWorksp_h[1] =
      P4p2_integral_B.Integrator[2];

    /* SignalConversion: '<S7>/TmpSignal ConversionAtTo Workspace3Inport1' */
    P4p2_integral_B.TmpSignalConversionAtToWorksp_e[0] = P4p2_integral_B.Gain1[3];
    P4p2_integral_B.TmpSignalConversionAtToWorksp_e[1] =
      P4p2_integral_B.Integrator[3];

    /* SignalConversion: '<S7>/TmpSignal ConversionAtTo Workspace4Inport1' */
    P4p2_integral_B.TmpSignalConversionAtToWorksp_m[0] = P4p2_integral_B.Gain1[4];
    P4p2_integral_B.TmpSignalConversionAtToWorksp_m[1] =
      P4p2_integral_B.Integrator[4];

    /* SignalConversion: '<S7>/TmpSignal ConversionAtTo Workspace5Inport1' */
    P4p2_integral_B.TmpSignalConversionAtToWorksp_a[0] = P4p2_integral_B.Gain1[5];
    P4p2_integral_B.TmpSignalConversionAtToWorksp_a[1] =
      P4p2_integral_B.Integrator[5];

    /* Constant: '<S5>/ ' */
    P4p2_integral_B.u = P4p2_integral_P.V_star;

    /* Constant: '<S5>/Constant1' */
    P4p2_integral_B.Constant1[0] = P4p2_integral_P.P[0];
    P4p2_integral_B.Constant1[1] = P4p2_integral_P.P[1];
    P4p2_integral_B.Constant1[2] = P4p2_integral_P.P[2];
    P4p2_integral_B.Constant1[3] = P4p2_integral_P.P[3];
  }

  /* FromWorkspace: '<S8>/FromWs' */
  {
    real_T *pDataValues = (real_T *) P4p2_integral_DW.FromWs_PWORK.DataPtr;
    real_T *pTimeValues = (real_T *) P4p2_integral_DW.FromWs_PWORK.TimePtr;
    int_T currTimeIndex = P4p2_integral_DW.FromWs_IWORK.PrevIndex;
    real_T t = P4p2_integral_M->Timing.t[0];
    ...
    P4p2_integral_DW.FromWs_IWORK.PrevIndex = currTimeIndex;
  ...
  if (rtmIsMajorTimeStep(P4p2_integral_M)) {
    ...
    memcpy(&P4p2_integral_B.Constant[0], &P4p2_integral_P.K_bar[0], 10U * sizeof
           (real_T));
  }
  ...
  tmp[3] = P4p2_integral_X.Integrator_CSTATE_f;
  tmp[4] = P4p2_integral_X.Integrator1_CSTATE;
  ...
  for (i = 0; i < 2; i++) {
    tmp_0[i] = 0.0;
    for (i_0 = 0; i_0 < 5; i_0++) {
      tmp_0[i] += P4p2_integral_B.Constant[(i_0 << 1) + i] * tmp[i_0];
    }
  }
   ...
   */
  rtb_TmpSignalConversionAtProd_0 = (P4p2_integral_B.Constant1[1] * rtb_FromWs +
    P4p2_integral_B.Constant1[3] * 0.0) - tmp_0[1];
   ...
   *  Sum: '<S5>/Add'
   */
  P4p2_integral_B.Sum3 = ((P4p2_integral_B.Constant1[0] * rtb_FromWs +
    P4p2_integral_B.Constant1[2] * 0.0) - tmp_0[0]) + P4p2_integral_B.u;
  if (rtmIsMajorTimeStep(P4p2_integral_M)) {
  }
   ...
   *  Sum: '<S1>/Add'
   */
  u0 = (rtb_TmpSignalConversionAtProd_0 + P4p2_integral_B.Sum3) *
   ...
   *  Sum: '<S1>/Subtract'
   */
  u0 = (P4p2_integral_B.Sum3 - rtb_TmpSignalConversionAtProd_0) *
  ...
  if (rtmIsMajorTimeStep(P4p2_integral_M)) {
    ...
    for (i = 0; i < 18; i++) {
      ...
      P4p2_integral_B.Constant1_i[i] = P4p2_integral_P.C_se[i];

      /* Constant: '<S6>/Constant2' */
      P4p2_integral_B.Constant2[i] = P4p2_integral_P.L[i];
    }

    /* Constant: '<S6>/Constant3' */
    memcpy(&P4p2_integral_B.Constant3[0], &P4p2_integral_P.B_se[0], 12U * sizeof
           (real_T));

    /* Constant: '<S6>/Constant4' */
    memcpy(&P4p2_integral_B.Constant4[0], &P4p2_integral_P.A_se[0], 36U * sizeof
           (real_T));
  }
  ...
  for (i = 0; i < 3; i++) {
    tmp_1[i] = 0.0;
    for (i_0 = 0; i_0 < 6; i_0++) {
      tmp_1[i] += P4p2_integral_B.Constant1_i[3 * i_0 + i] *
   ...
   *  Product: '<S6>/Product1'
   */
  u0 = P4p2_integral_B.Gain1[0] - tmp_1[0];
  unnamed_idx_1 = P4p2_integral_B.Gain1[2] - tmp_1[1];
  unnamed_idx_2 = P4p2_integral_B.Gain1[4] - tmp_1[2];
  for (i = 0; i < 6; i++) {
    /* Product: '<S6>/Product1' incorporates:
     *  Sum: '<S6>/Add1'
     */
    tmp_2[i] = P4p2_integral_B.Constant2[i + 12] * unnamed_idx_2 +
      (P4p2_integral_B.Constant2[i + 6] * unnamed_idx_1 +
       P4p2_integral_B.Constant2[i] * u0);

    /* Product: '<S6>/Product4' incorporates:
     *  SignalConversion: '<S6>/TmpSignal ConversionAtProduct4Inport2'
     *  Sum: '<S6>/Add1'
     */
    tmp_3[i] = P4p2_integral_B.Constant3[i + 6] *
      rtb_TmpSignalConversionAtProd_0 + P4p2_integral_B.Constant3[i] *
  ...
  for (i = 0; i < 6; i++) {
    u0 = 0.0;
    for (i_0 = 0; i_0 < 6; i_0++) {
      u0 += P4p2_integral_B.Constant4[6 * i_0 + i] *
        P4p2_integral_B.Integrator[i_0];
    }

    P4p2_integral_B.Add1[i] = (tmp_2[i] + tmp_3[i]) + u0;
  }

  /* Sum: '<S9>/Sum1' */
  P4p2_integral_B.Sum1_b = P4p2_integral_B.Integrator[0] - rtb_FromWs;

  /* Sum: '<S9>/Sum2' */
  P4p2_integral_B.Sum2 = P4p2_integral_B.Integrator[3] - 0.0;
}
...
void P4p2_integral_derivatives(void)
{
  ...
  for (i = 0; i < 6; i++) {
    _rtXdot->Integrator_CSTATE[i] = P4p2_integral_B.Add1[i];
  }

  /* End of Derivatives for Integrator: '<S6>/Integrator' */

  /* Derivatives for Integrator: '<S9>/Integrator' */
  _rtXdot->Integrator_CSTATE_f = P4p2_integral_B.Sum1_b;

  /* Derivatives for Integrator: '<S9>/Integrator1' */
  _rtXdot->Integrator1_CSTATE = P4p2_integral_B.Sum2;
}
...
void P4p2_integral_initialize(void)
{
  ...
  /* Start for FromWorkspace: '<S8>/FromWs' */
  {
    ...
    P4p2_integral_DW.FromWs_PWORK.TimePtr = (void *) pTimeValues0;
    P4p2_integral_DW.FromWs_PWORK.DataPtr = (void *) pDataValues0;
    P4p2_integral_DW.FromWs_IWORK.PrevIndex = 0;
  }
...

  {
    ...
    P4p2_integral_X.Integrator_CSTATE_f = P4p2_integral_P.Integrator_IC_i;
...
RT_MODEL_P4p2_integral_T *P4p2_integral(void)
{
  ...
  rtmSetTFinal(P4p2_integral_M, 9.9);
  P4p2_integral_M->Timing.stepSize0 = 0.002;
  P4p2_integral_M->Timing.stepSize1 = 0.002;
  P4p2_integral_M->Timing.stepSize2 = 0.01;

  /* External mode info */
  P4p2_integral_M->Sizes.checksums[0] = (3535217381U);
  P4p2_integral_M->Sizes.checksums[1] = (4028667009U);
  P4p2_integral_M->Sizes.checksums[2] = (40694054U);
  P4p2_integral_M->Sizes.checksums[3] = (4270493259U);
...

  {
    ...
    for (i = 0; i < 10; i++) {
      P4p2_integral_B.Constant[i] = 0.0;
    }

    for (i = 0; i < 18; i++) {
      P4p2_integral_B.Constant1_i[i] = 0.0;
    }

    for (i = 0; i < 18; i++) {
      P4p2_integral_B.Constant2[i] = 0.0;
    }

    for (i = 0; i < 12; i++) {
      P4p2_integral_B.Constant3[i] = 0.0;
    }

    for (i = 0; i < 36; i++) {
      P4p2_integral_B.Constant4[i] = 0.0;
    }

    for (i = 0; i < 6; i++) {
      P4p2_integral_B.Add1[i] = 0.0;
    }
    ...
    P4p2_integral_B.TmpSignalConversionAtToWorkspac[0] = 0.0;
    P4p2_integral_B.TmpSignalConversionAtToWorkspac[1] = 0.0;
    P4p2_integral_B.TmpSignalConversionAtToWorksp_g[0] = 0.0;
    P4p2_integral_B.TmpSignalConversionAtToWorksp_g[1] = 0.0;
    P4p2_integral_B.TmpSignalConversionAtToWorksp_h[0] = 0.0;
    P4p2_integral_B.TmpSignalConversionAtToWorksp_h[1] = 0.0;
    P4p2_integral_B.TmpSignalConversionAtToWorksp_e[0] = 0.0;
    P4p2_integral_B.TmpSignalConversionAtToWorksp_e[1] = 0.0;
    P4p2_integral_B.TmpSignalConversionAtToWorksp_m[0] = 0.0;
    P4p2_integral_B.TmpSignalConversionAtToWorksp_m[1] = 0.0;
    P4p2_integral_B.TmpSignalConversionAtToWorksp_a[0] = 0.0;
    P4p2_integral_B.TmpSignalConversionAtToWorksp_a[1] = 0.0;
    P4p2_integral_B.u = 0.0;
    P4p2_integral_B.Constant1[0] = 0.0;
    P4p2_integral_B.Constant1[1] = 0.0;
    P4p2_integral_B.Constant1[2] = 0.0;
    P4p2_integral_B.Constant1[3] = 0.0;
    P4p2_integral_B.Sum3 = 0.0;
    P4p2_integral_B.FrontmotorSaturation = 0.0;
    P4p2_integral_B.BackmotorSaturation = 0.0;
    P4p2_integral_B.Sum1_b = 0.0;
  ...
  P4p2_integral_M->Sizes.numBlocks = (72);/* Number of blocks */
  P4p2_integral_M->Sizes.numBlockIO = (32);/* Number of block outputs */
  P4p2_integral_M->Sizes.numBlockPrms = (236);/* Sum of parameter "widths" */
