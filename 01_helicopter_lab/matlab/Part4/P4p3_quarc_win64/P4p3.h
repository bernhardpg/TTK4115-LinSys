...
typedef struct {
  ...
  real_T Constant1[12];                /* '<S6>/Constant1' */
  real_T Constant2[12];                /* '<S6>/Constant2' */
...
struct P_P4p3_T_ {
  ...
  real_T B_se[12];                     /* Variable: B_se
                                        ...
                                        */
  real_T C_se_no_pitch[12];            /* Variable: C_se_no_pitch
...
extern void P4p3_output0(void);
extern void P4p3_update0(void);
extern void P4p3_output(int_T tid);
extern void P4p3_update(int_T tid);
 ...
 * '<Root>' : 'P4p3'
 * '<S1>'   : 'P4p3/Conversion'
 * '<S2>'   : 'P4p3/Degrees to Radians'
 * '<S3>'   : 'P4p3/Heli 3D'
 * '<S4>'   : 'P4p3/Joystick'
 * '<S5>'   : 'P4p3/LQR regulator'
 * '<S6>'   : 'P4p3/Observer'
 * '<S7>'   : 'P4p3/Plot2'
 * '<S8>'   : 'P4p3/Signal Builder'
 * '<S9>'   : 'P4p3/State augmenter'
 * '<S10>'  : 'P4p3/Heli 3D/Elevation rad to deg'
 * '<S11>'  : 'P4p3/Heli 3D/Elevation rate rad to deg'
 * '<S12>'  : 'P4p3/Heli 3D/Pitch rad to deg'
 * '<S13>'  : 'P4p3/Heli 3D/Pitch rate rad to deg'
 * '<S14>'  : 'P4p3/Heli 3D/Travel rad to deg'
 * '<S15>'  : 'P4p3/Heli 3D/Travel rate  rad to deg'
 */
