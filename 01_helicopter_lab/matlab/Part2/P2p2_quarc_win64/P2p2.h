...
typedef struct {
  ...
  real_T FromWs;                       /* '<S8>/FromWs' */
  real_T TmpSignalConversionAtToWorksp_a[2];
  real_T u;                            /* '<Root>/        ' */
  real_T Sum_h;                        /* '<S10>/Sum' */
  real_T K_ei;                         /* '<S10>/K_ei' */
...
extern void P2p2_output0(void);
extern void P2p2_update0(void);
extern void P2p2_output(int_T tid);
extern void P2p2_update(int_T tid);
 ...
 * '<Root>' : 'P2p2'
 * '<S1>'   : 'P2p2/Conversion'
 * '<S2>'   : 'P2p2/Degrees to Radians'
 * '<S3>'   : 'P2p2/Elevation controller'
 * '<S4>'   : 'P2p2/Heli 3D'
 * '<S5>'   : 'P2p2/Joystick'
 * '<S6>'   : 'P2p2/Pitch controller'
 * '<S7>'   : 'P2p2/Plot1'
 * '<S8>'   : 'P2p2/Signal Builder'
 * '<S9>'   : 'P2p2/Travel rate controller'
 * '<S10>'  : 'P2p2/Elevation controller/Elevation controller'
 * '<S11>'  : 'P2p2/Heli 3D/Elevation rad to deg'
 * '<S12>'  : 'P2p2/Heli 3D/Elevation rate rad to deg'
 * '<S13>'  : 'P2p2/Heli 3D/Pitch rad to deg'
 * '<S14>'  : 'P2p2/Heli 3D/Pitch rate rad to deg'
 * '<S15>'  : 'P2p2/Heli 3D/Travel rad to deg'
 * '<S16>'  : 'P2p2/Heli 3D/Travel rate  rad to deg'
 * '<S17>'  : 'P2p2/Pitch controller/Subsystem'
 */
