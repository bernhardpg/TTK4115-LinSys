  ...
  ;%**************************
    ...
    ;%
	  ...
	  ;% P2p2_B.TmpSignalConversionAtToWorkspac
	  section.data(13).logicalSrcIdx = 12;
	  section.data(13).dtTransOffset = 17;
	
	  ;% P2p2_B.TmpSignalConversionAtToWorksp_g
	  section.data(14).logicalSrcIdx = 13;
	  section.data(14).dtTransOffset = 19;
	
	  ;% P2p2_B.TmpSignalConversionAtToWorksp_h
	  section.data(15).logicalSrcIdx = 14;
	  section.data(15).dtTransOffset = 21;
	
	  ;% P2p2_B.TmpSignalConversionAtToWorksp_e
	  section.data(16).logicalSrcIdx = 15;
	  section.data(16).dtTransOffset = 23;
	
	  ;% P2p2_B.TmpSignalConversionAtToWorksp_m
	  section.data(17).logicalSrcIdx = 16;
	  ...
	  ;% P2p2_B.TmpSignalConversionAtToWorksp_a
	  section.data(19).logicalSrcIdx = 18;
  ...
  ;%*******************
    ...
    ;%
	  ...
	  ;% P2p2_DW.ToWorkspace2_PWORK.LoggedData
	  section.data(3).logicalSrcIdx = 14;
	  section.data(3).dtTransOffset = 2;
	
	  ;% P2p2_DW.ToWorkspace3_PWORK.LoggedData
	  section.data(4).logicalSrcIdx = 15;
	  section.data(4).dtTransOffset = 3;
	
	  ;% P2p2_DW.ToWorkspace4_PWORK.LoggedData
	  section.data(5).logicalSrcIdx = 16;
	  section.data(5).dtTransOffset = 4;
	
	  ;% P2p2_DW.FromWs_PWORK.TimePtr
	  section.data(6).logicalSrcIdx = 17;
	  section.data(6).dtTransOffset = 5;
	
	  ;% P2p2_DW.ToWorkspace5_PWORK.LoggedData
	  section.data(7).logicalSrcIdx = 18;
	  section.data(7).dtTransOffset = 6;
	
	  ;% P2p2_DW.Vs_PWORK.LoggedData
	  ...
	  ;% P2p2_DW.FromWs_IWORK.PrevIndex
  ...
  targMap.checksum0 = 20337500;
  targMap.checksum1 = 2180515081;
  targMap.checksum2 = 4159674338;
  targMap.checksum3 = 2302508972;
