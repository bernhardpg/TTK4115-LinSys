 ...
 * C source code generated on : Fri Oct 19 03:37:41 2018
 *
...
void P2p2_output0(void)                /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (rtmIsMajorTimeStep(P2p2_M)) {
    ...
    /* Gain: '<S13>/Gain' */
    P2p2_B.Gain = P2p2_P.Gain_Gain * P2p2_B.PitchCounttorad;

    /* Sum: '<Root>/Sum1' incorporates:
     *  Constant: '<Root>/   '
     */
    P2p2_B.Sum1 = P2p2_B.Gain - P2p2_P.P_OFF;
  }

  /* TransferFcn: '<S4>/Pitch: Transfer Fcn' */
  rtb_Backgain = 0.0;
  rtb_Backgain += P2p2_P.PitchTransferFcn_C * P2p2_X.PitchTransferFcn_CSTATE;
  rtb_Backgain += P2p2_P.PitchTransferFcn_D * P2p2_B.PitchCounttorad;

  /* Gain: '<S14>/Gain' */
  P2p2_B.Gain_b = P2p2_P.Gain_Gain_a * rtb_Backgain;
  if (rtmIsMajorTimeStep(P2p2_M)) {
    ...
    /* Gain: '<S11>/Gain' */
    P2p2_B.Gain_e = P2p2_P.Gain_Gain_l * P2p2_B.ElevationCounttorad;

    /* Sum: '<Root>/Sum' incorporates:
     *  Constant: '<Root>/     '
     */
    P2p2_B.Sum = P2p2_B.Gain_e - P2p2_P.E_OFF;
  }

  /* TransferFcn: '<S4>/Elevation: Transfer Fcn' */
  rtb_Backgain = 0.0;
  rtb_Backgain += P2p2_P.ElevationTransferFcn_C *
    P2p2_X.ElevationTransferFcn_CSTATE;
  rtb_Backgain += P2p2_P.ElevationTransferFcn_D * P2p2_B.ElevationCounttorad;

  /* Gain: '<S12>/Gain' */
  P2p2_B.Gain_d = P2p2_P.Gain_Gain_n * rtb_Backgain;
  if (rtmIsMajorTimeStep(P2p2_M)) {
    ...
    /* Gain: '<S15>/Gain' */
    P2p2_B.Gain_p = P2p2_P.Gain_Gain_ar * P2p2_B.TravelCounttorad;
  }

  /* TransferFcn: '<S4>/Travel: Transfer Fcn' */
  rtb_Backgain = 0.0;
  rtb_Backgain += P2p2_P.TravelTransferFcn_C * P2p2_X.TravelTransferFcn_CSTATE;
  rtb_Backgain += P2p2_P.TravelTransferFcn_D * P2p2_B.TravelCounttorad;

  /* Gain: '<S16>/Gain' */
  P2p2_B.Gain_dc = P2p2_P.Gain_Gain_lu * rtb_Backgain;

  /* Gain: '<S2>/Gain1' */
  P2p2_B.Gain1[0] = P2p2_P.Gain1_Gain * P2p2_B.Sum1;
  P2p2_B.Gain1[1] = P2p2_P.Gain1_Gain * P2p2_B.Gain_b;
  P2p2_B.Gain1[2] = P2p2_P.Gain1_Gain * P2p2_B.Sum;
  P2p2_B.Gain1[3] = P2p2_P.Gain1_Gain * P2p2_B.Gain_d;
  P2p2_B.Gain1[4] = P2p2_P.Gain1_Gain * P2p2_B.Gain_p;
  P2p2_B.Gain1[5] = P2p2_P.Gain1_Gain * P2p2_B.Gain_dc;
  if (rtmIsMajorTimeStep(P2p2_M)) {
    /* SignalConversion: '<S7>/TmpSignal ConversionAtTo WorkspaceInport1' */
    P2p2_B.TmpSignalConversionAtToWorkspac[0] = 0.0;
    P2p2_B.TmpSignalConversionAtToWorkspac[1] = P2p2_B.Gain1[1];

    /* SignalConversion: '<S7>/TmpSignal ConversionAtTo Workspace1Inport1' */
    P2p2_B.TmpSignalConversionAtToWorksp_g[0] = 0.0;
    P2p2_B.TmpSignalConversionAtToWorksp_g[1] = P2p2_B.Gain1[0];

    /* SignalConversion: '<S7>/TmpSignal ConversionAtTo Workspace2Inport1' */
    P2p2_B.TmpSignalConversionAtToWorksp_h[0] = 0.0;
    P2p2_B.TmpSignalConversionAtToWorksp_h[1] = P2p2_B.Gain1[2];

    /* SignalConversion: '<S7>/TmpSignal ConversionAtTo Workspace3Inport1' */
    P2p2_B.TmpSignalConversionAtToWorksp_e[0] = 0.0;
    P2p2_B.TmpSignalConversionAtToWorksp_e[1] = P2p2_B.Gain1[3];

    /* SignalConversion: '<S7>/TmpSignal ConversionAtTo Workspace4Inport1' */
    P2p2_B.TmpSignalConversionAtToWorksp_m[0] = 0.0;
    P2p2_B.TmpSignalConversionAtToWorksp_m[1] = P2p2_B.Gain1[4];
  }

  /* FromWorkspace: '<S8>/FromWs' */
  {
    real_T *pDataValues = (real_T *) P2p2_DW.FromWs_PWORK.DataPtr;
    real_T *pTimeValues = (real_T *) P2p2_DW.FromWs_PWORK.TimePtr;
    int_T currTimeIndex = P2p2_DW.FromWs_IWORK.PrevIndex;
    real_T t = P2p2_M->Timing.t[0];
    ...
    P2p2_DW.FromWs_IWORK.PrevIndex = currTimeIndex;
    ...
    /* Post output */
    {
      ...
      if (t1 == t2) {
        if (t < t1) {
          P2p2_B.FromWs = pDataValues[currTimeIndex];
        } else {
          P2p2_B.FromWs = pDataValues[currTimeIndex + 1];
        }
      } else {
        ...
        P2p2_B.FromWs = (real_T) rtInterpolate(d1, d2, f1, f2);
        pDataValues += 6;
      }
    }
  }
  ...
  if (rtmIsMajorTimeStep(P2p2_M)) {
    ...
    P2p2_B.TmpSignalConversionAtToWorksp_a[0] = P2p2_B.FromWs;
    P2p2_B.TmpSignalConversionAtToWorksp_a[1] = P2p2_B.Gain1[5];

    /* Constant: '<Root>/        ' */
    P2p2_B.u = P2p2_P._Value;
  }
  ...
  /* Sum: '<S3>/Sum' */
  rtb_Sum = P2p2_B.u - P2p2_B.Gain1[2];

  /* Sum: '<S10>/Sum' incorporates:
   *  Gain: '<S10>/K_ed'
   *  Gain: '<S10>/K_ep'
   */
  P2p2_B.Sum_h = (P2p2_P.K_ep * rtb_Sum + rtb_Backgain) - P2p2_P.K_ed *
    P2p2_B.Gain1[3];
  if (rtmIsMajorTimeStep(P2p2_M)) {
  }

  /* Sum: '<S17>/Sum of Elements1' incorporates:
   *  Gain: '<S17>/Kd '
   *  Gain: '<S17>/Kp'
   *  Gain: '<S9>/Kp'
   ...
   *  Sum: '<S9>/e~lambda'
   */
  rtb_Backgain = ((P2p2_B.FromWs - P2p2_B.Gain1[5]) * P2p2_P.K_rp -
                  P2p2_B.Gain1[0]) * P2p2_P.K_pp - P2p2_P.K_pd * P2p2_B.Gain1[1];

  /* Sum: '<S1>/Add' */
  rtb_Add = rtb_Backgain + P2p2_B.Sum_h;

  /* Gain: '<S1>/Back gain' incorporates:
   *  Sum: '<S1>/Subtract'
   */
  rtb_Backgain = (P2p2_B.Sum_h - rtb_Backgain) * P2p2_P.Backgain_Gain;

  /* Gain: '<S10>/K_ei' */
  P2p2_B.K_ei = P2p2_P.K_ei * rtb_Sum;
  if (rtmIsMajorTimeStep(P2p2_M)) {
  }

  /* Gain: '<S1>/Front gain' */
  rtb_Sum = P2p2_P.Frontgain_Gain * rtb_Add;

  /* Saturate: '<S4>/Front motor: Saturation' */
  if (rtb_Sum > P2p2_P.FrontmotorSaturation_UpperSat) {
    P2p2_B.FrontmotorSaturation = P2p2_P.FrontmotorSaturation_UpperSat;
  } else if (rtb_Sum < P2p2_P.FrontmotorSaturation_LowerSat) {
    P2p2_B.FrontmotorSaturation = P2p2_P.FrontmotorSaturation_LowerSat;
  } else {
    P2p2_B.FrontmotorSaturation = rtb_Sum;
  }
...
void P2p2_initialize(void)
{
  ...
  /* Start for FromWorkspace: '<S8>/FromWs' */
  {
    ...
    P2p2_DW.FromWs_PWORK.TimePtr = (void *) pTimeValues0;
    P2p2_DW.FromWs_PWORK.DataPtr = (void *) pDataValues0;
    P2p2_DW.FromWs_IWORK.PrevIndex = 0;
  }
...
RT_MODEL_P2p2_T *P2p2(void)
{
  ...
  rtmSetTFinal(P2p2_M, 9.9);
  P2p2_M->Timing.stepSize0 = 0.002;
  P2p2_M->Timing.stepSize1 = 0.002;
  P2p2_M->Timing.stepSize2 = 0.01;

  /* External mode info */
  P2p2_M->Sizes.checksums[0] = (20337500U);
  P2p2_M->Sizes.checksums[1] = (2180515081U);
  P2p2_M->Sizes.checksums[2] = (4159674338U);
  P2p2_M->Sizes.checksums[3] = (2302508972U);
...

  {
    ...
    P2p2_B.Gain_dc = 0.0;
    P2p2_B.TmpSignalConversionAtToWorkspac[0] = 0.0;
    P2p2_B.TmpSignalConversionAtToWorkspac[1] = 0.0;
    P2p2_B.TmpSignalConversionAtToWorksp_g[0] = 0.0;
    P2p2_B.TmpSignalConversionAtToWorksp_g[1] = 0.0;
    P2p2_B.TmpSignalConversionAtToWorksp_h[0] = 0.0;
    P2p2_B.TmpSignalConversionAtToWorksp_h[1] = 0.0;
    P2p2_B.TmpSignalConversionAtToWorksp_e[0] = 0.0;
    P2p2_B.TmpSignalConversionAtToWorksp_e[1] = 0.0;
    P2p2_B.TmpSignalConversionAtToWorksp_m[0] = 0.0;
    P2p2_B.TmpSignalConversionAtToWorksp_m[1] = 0.0;
    P2p2_B.FromWs = 0.0;
    P2p2_B.TmpSignalConversionAtToWorksp_a[0] = 0.0;
    P2p2_B.TmpSignalConversionAtToWorksp_a[1] = 0.0;
    P2p2_B.u = 0.0;
    P2p2_B.Sum_h = 0.0;
    P2p2_B.K_ei = 0.0;
  ...
  P2p2_M->Sizes.numBlocks = (60);      /* Number of blocks */
  P2p2_M->Sizes.numBlockIO = (24);     /* Number of block outputs */
  P2p2_M->Sizes.numBlockPrms = (144);  /* Sum of parameter "widths" */
  return P2p2_M;
}
