 ...
 * C source code generated on : Fri Oct 19 03:25:47 2018
 *
...
void P2p1_output0(void)                /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (rtmIsMajorTimeStep(P2p1_M)) {
    ...
    /* S-Function Block: P2p1/Heli 3D/HIL Read Encoder Timebase (hil_read_encoder_timebase_block) */
    {
      ...
      if (result < 0) {
        ...
        rtb_DeadZonex = P2p1_DW.HILReadEncoderTimebase_Buffer[2];
      }
    }
    ...
    /* Gain: '<S12>/Gain' */
    P2p1_B.Gain = P2p1_P.Gain_Gain * P2p1_B.PitchCounttorad;

    /* Sum: '<Root>/Sum1' incorporates:
     *  Constant: '<Root>/   '
     */
    P2p1_B.Sum1 = P2p1_B.Gain - P2p1_P.P_OFF;
  }
  ...
  /* Gain: '<S13>/Gain' */
  P2p1_B.Gain_b = P2p1_P.Gain_Gain_a * rtb_Backgain;
  if (rtmIsMajorTimeStep(P2p1_M)) {
    /* Gain: '<S4>/Elevation: Count to rad' */
    P2p1_B.ElevationCounttorad = P2p1_P.ElevationCounttorad_Gain * rtb_DeadZonex;

    /* Gain: '<S10>/Gain' */
    P2p1_B.Gain_e = P2p1_P.Gain_Gain_l * P2p1_B.ElevationCounttorad;

    /* Sum: '<Root>/Sum' incorporates:
     *  Constant: '<Root>/     '
     */
    P2p1_B.Sum = P2p1_B.Gain_e - P2p1_P.E_OFF;
  }
  ...
  /* Gain: '<S11>/Gain' */
  P2p1_B.Gain_d = P2p1_P.Gain_Gain_n * rtb_Backgain;
  if (rtmIsMajorTimeStep(P2p1_M)) {
    ...
    /* Gain: '<S14>/Gain' */
    P2p1_B.Gain_p = P2p1_P.Gain_Gain_ar * P2p1_B.TravelCounttorad;
  }
  ...
  /* Gain: '<S15>/Gain' */
  P2p1_B.Gain_dc = P2p1_P.Gain_Gain_lu * rtb_Backgain;

  /* Gain: '<S2>/Gain1' */
  P2p1_B.Gain1[0] = P2p1_P.Gain1_Gain * P2p1_B.Sum1;
  P2p1_B.Gain1[1] = P2p1_P.Gain1_Gain * P2p1_B.Gain_b;
  P2p1_B.Gain1[2] = P2p1_P.Gain1_Gain * P2p1_B.Sum;
  P2p1_B.Gain1[3] = P2p1_P.Gain1_Gain * P2p1_B.Gain_d;
  P2p1_B.Gain1[4] = P2p1_P.Gain1_Gain * P2p1_B.Gain_p;
  P2p1_B.Gain1[5] = P2p1_P.Gain1_Gain * P2p1_B.Gain_dc;
  if (rtmIsMajorTimeStep(P2p1_M)) {
    /* SignalConversion: '<S7>/TmpSignal ConversionAtTo WorkspaceInport1' */
    P2p1_B.TmpSignalConversionAtToWorkspac[0] = 0.0;
    P2p1_B.TmpSignalConversionAtToWorkspac[1] = P2p1_B.Gain1[1];
    ...
    if (P2p1_B.RateTransitionx > P2p1_P.DeadZonex_End) {
      rtb_DeadZonex = P2p1_B.RateTransitionx - P2p1_P.DeadZonex_End;
    } else if (P2p1_B.RateTransitionx >= P2p1_P.DeadZonex_Start) {
      rtb_DeadZonex = 0.0;
    } else {
      rtb_DeadZonex = P2p1_B.RateTransitionx - P2p1_P.DeadZonex_Start;
    }
     ...
     *  Gain: '<S5>/Gain: x'
     */
    P2p1_B.Joystick_gain_x = P2p1_P.Gainx_Gain * rtb_DeadZonex *
      P2p1_P.Joystick_gain_x;

    /* SignalConversion: '<S7>/TmpSignal ConversionAtTo Workspace1Inport1' */
    P2p1_B.TmpSignalConversionAtToWorksp_g[0] = P2p1_B.Joystick_gain_x;
    P2p1_B.TmpSignalConversionAtToWorksp_g[1] = P2p1_B.Gain1[0];

    /* SignalConversion: '<S7>/TmpSignal ConversionAtTo Workspace2Inport1' */
    P2p1_B.TmpSignalConversionAtToWorksp_h[0] = 0.0;
    P2p1_B.TmpSignalConversionAtToWorksp_h[1] = P2p1_B.Gain1[2];

    /* SignalConversion: '<S7>/TmpSignal ConversionAtTo Workspace3Inport1' */
    P2p1_B.TmpSignalConversionAtToWorksp_e[0] = 0.0;
    P2p1_B.TmpSignalConversionAtToWorksp_e[1] = P2p1_B.Gain1[3];

    /* SignalConversion: '<S7>/TmpSignal ConversionAtTo Workspace4Inport1' */
    P2p1_B.TmpSignalConversionAtToWorksp_m[0] = 0.0;
    P2p1_B.TmpSignalConversionAtToWorksp_m[1] = P2p1_B.Gain1[4];

    /* SignalConversion: '<S7>/TmpSignal ConversionAtTo Workspace5Inport1' */
    P2p1_B.TmpSignalConversionAtToWorksp_a[0] = 0.0;
    P2p1_B.TmpSignalConversionAtToWorksp_a[1] = P2p1_B.Gain1[5];

    /* Constant: '<Root>/        ' */
    P2p1_B.u = P2p1_P._Value;
  }
  ...
  /* Sum: '<S3>/Sum' */
  rtb_Sum = P2p1_B.u - P2p1_B.Gain1[2];

  /* Sum: '<S9>/Sum' incorporates:
   *  Gain: '<S9>/K_ed'
   *  Gain: '<S9>/K_ep'
   */
  P2p1_B.Sum_h = (P2p1_P.K_ep * rtb_Sum + rtb_Backgain) - P2p1_P.K_ed *
    P2p1_B.Gain1[3];
  if (rtmIsMajorTimeStep(P2p1_M)) {
  }
   ...
   */
  rtb_Backgain = (P2p1_B.Joystick_gain_x - P2p1_B.Gain1[0]) * P2p1_P.K_pp -
    P2p1_P.K_pd * P2p1_B.Gain1[1];

  /* Sum: '<S1>/Add' */
  rtb_Add = rtb_Backgain + P2p1_B.Sum_h;

  /* Gain: '<S1>/Back gain' incorporates:
   *  Sum: '<S1>/Subtract'
   */
  rtb_Backgain = (P2p1_B.Sum_h - rtb_Backgain) * P2p1_P.Backgain_Gain;

  /* Gain: '<S9>/K_ei' */
  P2p1_B.K_ei = P2p1_P.K_ei * rtb_Sum;
  if (rtmIsMajorTimeStep(P2p1_M)) {
  }

  /* Gain: '<S1>/Front gain' */
  rtb_Sum = P2p1_P.Frontgain_Gain * rtb_Add;

  /* Saturate: '<S4>/Front motor: Saturation' */
  if (rtb_Sum > P2p1_P.FrontmotorSaturation_UpperSat) {
    P2p1_B.FrontmotorSaturation = P2p1_P.FrontmotorSaturation_UpperSat;
  } else if (rtb_Sum < P2p1_P.FrontmotorSaturation_LowerSat) {
    P2p1_B.FrontmotorSaturation = P2p1_P.FrontmotorSaturation_LowerSat;
  } else {
    P2p1_B.FrontmotorSaturation = rtb_Sum;
  }
...
RT_MODEL_P2p1_T *P2p1(void)
{
  ...
  /* External mode info */
  P2p1_M->Sizes.checksums[0] = (2802079808U);
  P2p1_M->Sizes.checksums[1] = (3490249726U);
  P2p1_M->Sizes.checksums[2] = (1102787020U);
  P2p1_M->Sizes.checksums[3] = (3256355220U);
...

  {
    ...
    P2p1_B.Gain_dc = 0.0;
    P2p1_B.TmpSignalConversionAtToWorkspac[0] = 0.0;
    P2p1_B.TmpSignalConversionAtToWorkspac[1] = 0.0;
    P2p1_B.RateTransitionx = 0.0;
    P2p1_B.Joystick_gain_x = 0.0;
    P2p1_B.TmpSignalConversionAtToWorksp_g[0] = 0.0;
    P2p1_B.TmpSignalConversionAtToWorksp_g[1] = 0.0;
    P2p1_B.TmpSignalConversionAtToWorksp_h[0] = 0.0;
    P2p1_B.TmpSignalConversionAtToWorksp_h[1] = 0.0;
    P2p1_B.TmpSignalConversionAtToWorksp_e[0] = 0.0;
    P2p1_B.TmpSignalConversionAtToWorksp_e[1] = 0.0;
    P2p1_B.TmpSignalConversionAtToWorksp_m[0] = 0.0;
    P2p1_B.TmpSignalConversionAtToWorksp_m[1] = 0.0;
    P2p1_B.TmpSignalConversionAtToWorksp_a[0] = 0.0;
    P2p1_B.TmpSignalConversionAtToWorksp_a[1] = 0.0;
    P2p1_B.u = 0.0;
    P2p1_B.Sum_h = 0.0;
    P2p1_B.K_ei = 0.0;
  ...
  P2p1_M->Sizes.numBlocks = (61);      /* Number of blocks */
  P2p1_M->Sizes.numBlockIO = (26);     /* Number of block outputs */
  P2p1_M->Sizes.numBlockPrms = (148);  /* Sum of parameter "widths" */
  return P2p1_M;
}
