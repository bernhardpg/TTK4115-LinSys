...
extern void P2p1_output0(void);
extern void P2p1_update0(void);
extern void P2p1_output(int_T tid);
extern void P2p1_update(int_T tid);
 ...
 * '<Root>' : 'P2p1'
 * '<S1>'   : 'P2p1/Conversion'
 * '<S2>'   : 'P2p1/Degrees to Radians'
 * '<S3>'   : 'P2p1/Elevation controller'
 * '<S4>'   : 'P2p1/Heli 3D'
 * '<S5>'   : 'P2p1/Joystick'
 * '<S6>'   : 'P2p1/Pitch controller'
 * '<S7>'   : 'P2p1/Plot1'
 * '<S8>'   : 'P2p1/Signal Builder'
 * '<S9>'   : 'P2p1/Elevation controller/Elevation controller'
 * '<S10>'  : 'P2p1/Heli 3D/Elevation rad to deg'
 * '<S11>'  : 'P2p1/Heli 3D/Elevation rate rad to deg'
 * '<S12>'  : 'P2p1/Heli 3D/Pitch rad to deg'
 * '<S13>'  : 'P2p1/Heli 3D/Pitch rate rad to deg'
 * '<S14>'  : 'P2p1/Heli 3D/Travel rad to deg'
 * '<S15>'  : 'P2p1/Heli 3D/Travel rate  rad to deg'
 * '<S16>'  : 'P2p1/Pitch controller/Subsystem'
 */
